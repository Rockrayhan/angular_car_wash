<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="#"><i class="glyphicon glyphicon-scissors" aria-hidden="true"></i><span>Washing Points</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Services</span> <span class="fa fa-angle-right" style="float: right"></span>
				...
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="add-services.php">Add</a></li>

					<li id="menu-academico-avaliacoes"><a href="manage-services.php">Manage</a></li>
				</ul>
			</li>
